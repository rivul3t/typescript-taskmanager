...
describe('Project API', () => {
    ...
    beforeAll(async () => {
        const user1 = await createTestUser('testProjectUser1', 'aboba', 'test@nc.com');
        const user2 = await createTestUser('testProjectUser2', 'aboba', 'test@mc.com');
    ...
    it('should return only user projects', async () => {
        ...
        const found = res.body.projects.some((project: any) => project.id === anotherProjectId);
